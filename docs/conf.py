...
latex_documents = [
    (master_doc, 'AGLOW.tex', u'AGLOW Documentation',
...
man_pages = [
    (master_doc, 'aglow', u'AGLOW Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AGLOW', u'AGLOW Documentation',
     author, 'AGLOW', 'Automated Grid-enabled LOFAR Workflows',
     'Miscellaneous'),
]
